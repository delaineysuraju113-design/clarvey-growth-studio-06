...
const HeroSection = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center section-padding py-20">
      ...
      />
      <h1
        className="mt-8 text-5xl sm:text-6xl lg:text-7xl font-heading font-bold leading-[1.05] text-foreground animate-fade-up text-center"
        style={{ animationDelay: "0.2s" }}
      >
        Delainey Suraju
      </h1>
      <p
        className="mt-3 text-sm sm:text-base tracking-[0.25em] uppercase text-muted-foreground font-medium animate-fade-up text-center"
