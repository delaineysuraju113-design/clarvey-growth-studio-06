...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-end overflow-hidden">
      ...
      <div className="relative z-10 section-padding pb-10 pt-4 text-center">
        ...
        <p className="mt-2 text-sm sm:text-base tracking-[0.25em] uppercase text-muted-foreground font-medium animate-fade-up" style={{ animationDelay: "0.3s" }}>
          Student-Athlete · Entrepreneur · Strategist
        </p>

        <div className="mt-6 flex flex-wrap justify-center gap-4 animate-fade-up" style={{ animationDelay: "0.4s" }}>
          <a
            href="#about"
