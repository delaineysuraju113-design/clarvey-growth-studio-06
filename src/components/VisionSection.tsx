...
import visionImg from "@/assets/IMG_8076.jpg";

const VisionSection = () => {
  return (
    <section id="vision" className="section-padding bg-card">
      <div className="section-container">
        {/* Changed layout to a two-column grid for perfect balance */}
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="max-w-3xl">
            ...
            <div className="space-y-6 text-gray-800 leading-relaxed">
              ...
              <p>
                My background made me who I am, and these dreams won't stop until they're reality. Inspired by every win and loss, I'll keep enduring as long as the <strong className="text-black font-extrabold">Lord</strong> lets me.
              </p>
            </div>
          ...
          {/* Right Column: The Image (Added and Styled for Balance) */}
          <div className="w-full flex justify-center lg:justify-end">
              <img
                src={visionImg}
                alt="Delainey Suraju Future Vision"
                className="w-full max-w-[420px] rounded-lg shadow-lg object-cover aspect-[3/4] border border-border"
              />
          </div>
        </div>
      </div>
